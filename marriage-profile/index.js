...
var profileUserBirthdateElement;                                        // profile user birthdate comes
...
var profileUserColorKey= "Complection";                                 // profile user color key
...
var profileUserBloodGrouoKey= "Blood Group";                            // profile user blood group key
...
/* On page load */
    ...
    (
        "DOMContentLoaded", () =>                                       // wait until DOM get load into browser
        {
            ...
            this.profileUserNameElement.innerHTML=
            this.profileUserNameValue;                                  // provide profile user name value
            ...
            this.profileUserWorkElement.innerHTML=
            this.profileUserWorkValue;                                  // provide profile user work value

            this.profileUserMobilElement= document.getElementById
            (
                this.profileUserMobilElementId
            );                                                          // find profile user mobile element
            this.profileUserMobilElement.innerHTML=
            this.profileUserMobilValue;                                 // provide profile user mobile value

            this.profileUserEmailElement= document.getElementById
            (
                this.profileUserEmailElementId
            );                                                          // find profile user email element
            this.profileUserEmailElement.innerHTML=
            this.profileUserEmailValue;                                 // provide profile user email value
            ...
            this.keys= this.profileUserBirthdateElement
            .getElementsByClassName('key');                             // get elements of class key
            this.keys[0].innerHTML= 
            this.profileUserBirthdateKey;                               // assign key value to 1st element we found
            this.values= 
            this.profileUserBirthdateElement
            .getElementsByClassName('value');                           // get elements of class value
            this.values[0].innerHTML= 
            this.profileUserBirthdateValue;                             // assign value to to 1st element we found
            ...
            this.keys= this.profileUserBirthplaceElement
            .getElementsByClassName('key');                             // get elements of class key
            this.keys[0].innerHTML= 
            this.profileUserBirthplaceKey;                              // assign key value to 1st element we found
            this.values= 
            this.profileUserBirthplaceElement
            .getElementsByClassName('value');                           // get elements of class value
            this.values[0].innerHTML= 
            this.profileUserBirthplaceValue;                            // assign value to to 1st element we found

            this.profileUserColorElement= document.getElementById
            (
                this.profileUserColorElementId
            );                                                          // find profile user color element
            this.keys= this.profileUserColorElement
            .getElementsByClassName('key');                             // get elements of class key
            this.keys[0].innerHTML= 
            this.profileUserColorKey;                                   // assign key value to 1st element we found
            this.values= 
            this.profileUserColorElement
            .getElementsByClassName('value');                           // get elements of class value
            this.values[0].innerHTML= 
            this.profileUserColorValue;                                 // assign value to to 1st element we found

            this.profileUserHeightElement= document.getElementById
            (
                this.profileUserHeightElementId
            );                                                          // find profile user height element
            this.keys= this.profileUserHeightElement
            .getElementsByClassName('key');                             // get elements of class key
            this.keys[0].innerHTML= 
            this.profileUserHeightKey;                                  // assign key value to 1st element we found
            this.values= 
            this.profileUserHeightElement
            .getElementsByClassName('value');                           // get elements of class value
            this.values[0].innerHTML= 
            this.profileUserHeightValue;                                // assign value to to 1st element we found
            ...
            this.keys= this.profileUserBloodGroupElement
            .getElementsByClassName('key');                             // get elements of class key
            this.keys[0].innerHTML= 
            this.profileUserBloodGroupKey;                              // assign key value to 1st element we found
            this.values= 
            this.profileUserBloodGroupElement
            .getElementsByClassName('value');                           // get elements of class value
            this.values[0].innerHTML= 
            this.profileUserBloodGroupValue;                            // assign value to to 1st element we found
            ...
            this.profileUserHeaderElement.innerHTML=
            this.profileUserHeaderValue;                                // provide profile user header value
        }
    );
/* On page load */